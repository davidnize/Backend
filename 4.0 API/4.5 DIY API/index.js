...
app.get("/jokes/:id", (req, res) => {
  ...
  const foundJoke = jokes.find((jokes) => jokes.id === id);
  res.json(foundJoke);
});
...
(app.put("/jokes/:id"),
  (req, res) => {
    ...
    jokes[searchIndex] = replacemtJoke;
    res.json(replacemtJoke);
  });
...
app.delete("/jokes/:id", (req, res) => {
  ...
  if (searchIndex > -1) {
    ...
    res
      .status(404).json({ error: `Joke with id: ${id} not found. No jokes were deleted.` });
  }
});
